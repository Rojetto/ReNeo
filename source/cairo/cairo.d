...
alias cairo_device_t = _cairo_device;
...
alias cairo_matrix_t = _cairo_matrix;
...
alias cairo_pattern_t = _cairo_pattern;
...
alias cairo_user_data_key_t = _cairo_user_data_key;
...
alias cairo_status_t = _cairo_status;
...
alias cairo_content_t = _cairo_content;
...
alias cairo_format_t = _cairo_format;
 ...
 * Since: 1.0
 **/
alias cairo_write_func_t = _cairo_status function (
    void* closure,
    const(ubyte)* data,
    uint length);
 ...
 * Since: 1.0
 **/
alias cairo_read_func_t = _cairo_status function (
    void* closure,
    ubyte* data,
    uint length);
...
alias cairo_rectangle_int_t = _cairo_rectangle_int;
...
alias cairo_operator_t = _cairo_operator;
...
alias cairo_antialias_t = _cairo_antialias;
...
alias cairo_fill_rule_t = _cairo_fill_rule;
...
alias cairo_line_cap_t = _cairo_line_cap;
...
alias cairo_line_join_t = _cairo_line_join;
...
alias cairo_rectangle_t = _cairo_rectangle;
...
alias cairo_rectangle_list_t = _cairo_rectangle_list;
...
enum CAIRO_TAG_DEST = "cairo.dest";
enum CAIRO_TAG_LINK = "Link";
...
alias cairo_scaled_font_t = _cairo_scaled_font;
...
alias cairo_font_face_t = _cairo_font_face;
...
alias cairo_text_cluster_flags_t = _cairo_text_cluster_flags;
...
alias cairo_font_slant_t = _cairo_font_slant;
...
alias cairo_font_weight_t = _cairo_font_weight;
...
alias cairo_subpixel_order_t = _cairo_subpixel_order;
...
alias cairo_hint_style_t = _cairo_hint_style;
...
alias cairo_hint_metrics_t = _cairo_hint_metrics;
...
alias cairo_font_options_t = _cairo_font_options;
...
c_ulong cairo_font_options_hash (const(cairo_font_options_t)* options);
...
alias cairo_font_type_t = _cairo_font_type;
 ...
 * Since: 1.8
 **/
alias cairo_user_scaled_font_init_func_t = _cairo_status function (
    cairo_scaled_font_t* scaled_font,
    cairo_t* cr,
    cairo_font_extents_t* extents);
 ...
 * Since: 1.8
 **/
alias cairo_user_scaled_font_render_glyph_func_t = _cairo_status function (
    cairo_scaled_font_t* scaled_font,
    c_ulong glyph,
    cairo_t* cr,
    cairo_text_extents_t* extents);
 ...
 * Since: 1.8
 **/
alias cairo_user_scaled_font_text_to_glyphs_func_t = _cairo_status function (
    cairo_scaled_font_t* scaled_font,
    const(char)* utf8,
    int utf8_len,
    cairo_glyph_t** glyphs,
 ...
 * Since: 1.8
 **/
alias cairo_user_scaled_font_unicode_to_glyph_func_t = _cairo_status function (
    cairo_scaled_font_t* scaled_font,
    c_ulong unicode,
    c_ulong* glyph_index);
...
alias cairo_path_data_type_t = _cairo_path_data_type;
 ...
 * Since: 1.0
 **/
alias cairo_path_data_t = _cairo_path_data_t;
...
alias cairo_device_type_t = _cairo_device_type;
...
alias cairo_surface_observer_callback_t = void function (
    cairo_surface_t* observer,
    cairo_surface_t* target,
    void* data);
...
alias cairo_surface_type_t = _cairo_surface_type;
...
enum CAIRO_MIME_TYPE_CCITT_FAX = "image/g3fax";
enum CAIRO_MIME_TYPE_CCITT_FAX_PARAMS = "application/x-cairo.ccitt.params";
enum CAIRO_MIME_TYPE_EPS = "application/postscript";
enum CAIRO_MIME_TYPE_EPS_PARAMS = "application/x-cairo.eps.params";
 ...
 * Since: 1.12
 **/
alias cairo_raster_source_acquire_func_t = _cairo_surface* function (
 ...
 * Since: 1.12
 **/
alias cairo_raster_source_release_func_t = void function (
    cairo_pattern_t* pattern,
    void* callback_data,
    cairo_surface_t* surface);
 ...
 * Since: 1.12
 **/
alias cairo_raster_source_snapshot_func_t = _cairo_status function (
    cairo_pattern_t* pattern,
    void* callback_data);
 ...
 * Since: 1.12
 **/
alias cairo_raster_source_copy_func_t = _cairo_status function (
    cairo_pattern_t* pattern,
    void* callback_data,
 ...
 * Since: 1.12
 **/
alias cairo_raster_source_finish_func_t = void function (
    cairo_pattern_t* pattern,
    void* callback_data);
...
alias cairo_pattern_type_t = _cairo_pattern_type;
...
alias cairo_extend_t = _cairo_extend;
...
alias cairo_filter_t = _cairo_filter;
...
alias cairo_region_t = _cairo_region;
...
alias cairo_region_overlap_t = _cairo_region_overlap;
